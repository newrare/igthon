...
This is :class:`~src.entry.donchian_er.DonchianEntry` with one extra, harder
...
Documented in ``docs/strategies/donchian-projection.md``.
"""
...
class DonchianProjectionEntry(EntryStrategy):
    ...
    @classmethod
    def from_settings(cls, settings) -> DonchianProjectionEntry:
