...
pairing is :class:`~src.exit.close_zoneprofit.CloseZoneProfit`).
...
Documented in ``docs/strategies/open_donchian.md``.
"""
...
@dataclass
class OpenDonchian(EntryStrategy):
    ...
    @classmethod
    def from_settings(cls, settings) -> OpenDonchian:
