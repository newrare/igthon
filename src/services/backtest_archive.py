...
:meth:`src.services.candle_store.CandleStore.dump_and_purge`). This module reads
those files back into :class:`~src.services.price_buffer.Candle` objects so the
