...
The project's live strategy (:mod:`src.core.indicators` + the open/close rules
in :mod:`src.execution.trading`) is a single hard-wired *long-only* trend
...
:mod:`src.core.indicators` where possible (``atr``, ``efficiency_ratio``);
